...
import ch.hsr.se2.kartenverwaltung.activities.dummy.DummyContent;

/**
 * A fragment representing a single Karte detail screen.
...
public class CardDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.karte_detail)).setText(mItem.content);
        }
